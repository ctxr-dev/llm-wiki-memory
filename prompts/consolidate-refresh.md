...
5. **Do not invent.** Never fabricate version numbers, commits, or file paths. If the cluster doesn't say enough to rewrite confidently, prefer `keep` with `stale_after: true` over a guess.
