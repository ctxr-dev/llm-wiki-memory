...
export function CommandPalette({
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-xl rounded-lg bg-white dark:bg-slate-800 shadow-xl"
        onClick={(event) => event.stopPropagation()}
        onKeyDown={onKeyDown}
      >
        <div className="flex items-center gap-2 border-b border-slate-100 dark:border-slate-800 p-2">
          <input
            autoFocus
            value={query}
          ...
          {!showWikis && (
            <button
              ...
              className="rounded bg-slate-100 dark:bg-slate-800 px-2 py-1 text-xs text-slate-600 dark:text-slate-300"
            >
